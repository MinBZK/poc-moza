const i=`<svg xmlns="http://www.w3.org/2000/svg" xml:space="preserve" baseProfile="tiny" version="1.2" viewBox="0 0 24 24">
...
</svg>`,d=`<svg xmlns="http://www.w3.org/2000/svg" baseProfile="tiny" version="1.2" viewBox="0 0 24 24">
<path fill="none" d="M0 0h24v24H0z"/>
...
</svg>`,p={title:"Componenten/Icon-link",tags:["autodocs"]},e={parameters:{docs:{description:{story:"Een link met een SVG-icoon ervoor. Het icoon kleurt mee met de tekst via currentColor."}}},argTypes:{label:{control:"text"}},args:{label:"Contactgegevens wijzigen"},render:({label:r})=>`
<a class="icon-link" href="#">
    ${i}
    ${r}
</a>`},n={parameters:{docs:{description:{story:"Een niet-klikbaar label met een icoon, bijvoorbeeld voor het tonen van een gebruikersnaam."}}},argTypes:{label:{control:"text"}},args:{label:"R.J. Vogel"},render:({label:r})=>`
<span class="icon-label">
    ${d}
    ${r}
</span>`};var a,o,t;e.parameters={...e.parameters,docs:{...(a=e.parameters)==null?void 0:a.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
...
}`,...(t=(o=e.parameters)==null?void 0:o.docs)==null?void 0:t.source}}};var s,l,c;n.parameters={...n.parameters,docs:{...(s=n.parameters)==null?void 0:s.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
...
}`,...(c=(l=n.parameters)==null?void 0:l.docs)==null?void 0:c.source}}};const g=["Standaard","Label"];export{n as Label,e as Standaard,g as __namedExportsOrder,p as default};
