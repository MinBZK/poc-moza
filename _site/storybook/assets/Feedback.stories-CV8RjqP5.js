const z=`<svg xmlns="http://www.w3.org/2000/svg" xml:space="preserve" viewBox="0 0 24 24">
...
</svg>`,L=`<svg xmlns="http://www.w3.org/2000/svg" xml:space="preserve" viewBox="0 0 24 24">
...
</svg>`,F=`<svg xmlns="http://www.w3.org/2000/svg" xml:space="preserve" viewBox="0 0 24 24">
...
</svg>`,W={title:"Componenten/Feedback",tags:["autodocs"]},t={parameters:{docs:{description:{story:"Neutrale feedback zonder icoon. Geschikt voor algemene meldingen zonder specifieke urgentie."}}},argTypes:{titel:{control:"text"},inhoud:{control:"text"}},args:{titel:"Neutrale feedback",inhoud:"Lorem ipsum dolor sit amet consectetur adipisicing elit. Quibusdam asperiores odio nulla et?"},render:({titel:e,inhoud:n})=>`
<div class="feedback">
    <div>
        <p>${e}</p>
        <p>${n}</p>
...
`},i={parameters:{docs:{description:{story:"Informatieve feedback. Gebruik dit voor het tonen van aanvullende of verduidelijkende informatie."}}},argTypes:{titel:{control:"text"},inhoud:{control:"text"}},args:{titel:"Informatie",inhoud:"Lorem ipsum dolor sit amet consectetur, adipisicing elit. Deserunt sint mollitia culpa distinctio omnis quasi aperiam dolorem."},render:({titel:e,inhoud:n})=>`
...
`},o={parameters:{docs:{description:{story:"Succesfeedback. Gebruik dit om te bevestigen dat een gebruikersactie of een actie vanuit het systeem geslaagd is."}}},argTypes:{titel:{control:"text"},inhoud:{control:"text"}},args:{titel:"Succes",inhoud:"Lorem ipsum dolor sit amet consectetur adipisicing elit. Accusantium nulla doloribus in explicabo minus amet deleniti excepturi."},render:({titel:e,inhoud:n})=>`
...
`},s={parameters:{docs:{description:{story:"Waarschuwingsfeedback. Gebruik dit om de gebruiker te attenderen op een mogelijke aandachtspunt."}}},argTypes:{titel:{control:"text"},inhoud:{control:"text"}},args:{titel:"Waarschuwing",inhoud:"Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptate, incidunt perspiciatis adipisci iusto veniam magnam."},render:({titel:e,inhoud:n})=>`
...
`},a={parameters:{docs:{description:{story:"Foutmelding. Gebruik dit bij validatiefouten of mislukte acties. Heeft geen sluit-knop omdat de fout door de gebruiker opgelost moet worden om verder te kunnen."}}},argTypes:{titel:{control:"text"},inhoud:{control:"text"}},args:{titel:"Foutmelding",inhoud:"Lorem ipsum, dolor sit amet consectetur adipisicing elit. Necessitatibus iste tempore dignissimos fuga."},render:({titel:e,inhoud:n})=>`
...
`},c={parameters:{docs:{description:{story:"Overzicht van alle feedbackvarianten naast elkaar ter vergelijking."}}},render:()=>`
...
`};var r,d,l;t.parameters={...t.parameters,docs:{...(r=t.parameters)==null?void 0:r.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
...
\`
}`,...(l=(d=t.parameters)==null?void 0:d.docs)==null?void 0:l.source}}};var u,p,b;i.parameters={...i.parameters,docs:{...(u=i.parameters)==null?void 0:u.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
...
\`
}`,...(b=(p=i.parameters)==null?void 0:p.docs)==null?void 0:b.source}}};var m,v,k;o.parameters={...o.parameters,docs:{...(m=o.parameters)==null?void 0:m.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
...
\`
}`,...(k=(v=o.parameters)==null?void 0:v.docs)==null?void 0:k.source}}};var f,g,h;s.parameters={...s.parameters,docs:{...(f=s.parameters)==null?void 0:f.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
...
\`
}`,...(h=(g=s.parameters)==null?void 0:g.docs)==null?void 0:h.source}}};var x,w,$;a.parameters={...a.parameters,docs:{...(x=a.parameters)==null?void 0:x.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
...
\`
}`,...($=(w=a.parameters)==null?void 0:w.docs)==null?void 0:$.source}}};var S,y,I;c.parameters={...c.parameters,docs:{...(S=c.parameters)==null?void 0:S.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
...
\`
}`,...(I=(y=c.parameters)==null?void 0:y.docs)==null?void 0:I.source}}};const G=["Neutraal","Informatie","Succes","Waarschuwing","Foutmelding","AlleVarianten"];export{c as AlleVarianten,a as Foutmelding,i as Informatie,t as Neutraal,o as Succes,s as Waarschuwing,G as __namedExportsOrder,W as default};
