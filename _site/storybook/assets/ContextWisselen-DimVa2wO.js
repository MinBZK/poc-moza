...
`,e.jsx(n.p,{children:"Een gebruiker van MijnOverheid opereert niet in één vaste rol. Dezelfde persoon kan als burger, als ondernemer van meerdere bedrijven, als gemachtigde van een familielid én als professioneel dienstverlener voor weer andere organisaties ingelogd zijn. Het ontwerp moet dit ondersteunen idealiter zonder dat de gebruiker steeds opnieuw moet inloggen."}),`
`,e.jsx(n.p,{children:e.jsx(n.strong,{children:"Let wel: De geschetse ontwerp-oplossingen zijn niet gestaaft met huidige technische, juridische en/of organisatorische mogelijkheden, beperkingen en uitdagingen! Het schets een ideaalbeeld om naartoe te werken."})}),`
...
`,e.jsx(n.h3,{id:"zakelijk-ondernemer",children:"Zakelijk (ondernemer)"}),`
`,e.jsx(n.p,{children:"De zakelijke omgeving toont gegevens, verplichtingen en actualiteiten die specifiek zijn voor een onderneming. Een persoon kan eigenaar zijn van meerdere ondernemingen, zoals bijvoorbeeld:"}),`
...
`,e.jsxs(n.li,{children:[e.jsx(n.strong,{children:"Fallback zonder wisselaar"})," — als de feature flag uit staat, toont de header alleen de naam van de ingelogde persoon zonder dropdown. Dit maakt het mogelijk om de wisselaar geleidelijk te introduceren."]}),`
`]}),`
...
`,e.jsxs(n.li,{children:[e.jsx(n.strong,{children:"Niet alleen kleur"})," — kleur kan een ondersteunend signaal zijn, maar mag nooit het enige onderscheidende kenmerk zijn (WCAG 1.4.1: ",e.jsx(n.em,{children:"Use of Color"}),"). Elk visueel onderscheid moet ook zonder kleurwaarneming werken."]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.strong,{children:"Beperkt aantal contexttypes"})," — het onderscheid hoeft niet per organisatie maar per ",e.jsx(n.em,{children:"type"})," context: privé, zakelijk (eigen) en gemachtigd/belang. Dat zijn maximaal vier visuele varianten."]}),`
`]}),`
...
`,e.jsxs(n.li,{children:[e.jsx(n.strong,{children:"Hoe wordt misbruik voorkomen?"})," — als iemand gemachtigd is voor een ander, moeten acties gelogd worden. De gebruiker moet altijd zien namens wie er gehandeld wordt (prominente indicator)."]}),`
`]}),`
...
`,e.jsxs(n.ul,{children:[`
`,e.jsx(n.li,{children:"Huidige situatie: burger en ondernemer zijn gescheiden ingangen, zonder inline wisselmechanisme. Het accountwisselaar-patroon zou dit vervangen door een geïntegreerde ervaring."}),`
`]}),`
